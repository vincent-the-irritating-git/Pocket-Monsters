...
int main() {
	...
	std::cout<<Move_Pokedex::get_gen1_moves("Thunder Shock")->m_type->get_matchup_value(Pokemon_Pokedex::get_gen1_pokemon("Pikachu").get_type1()->get_type())->get_effectiveness();
