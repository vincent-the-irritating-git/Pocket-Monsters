...
int main() {
	Defence_Move barrier("Barrier", 15, 100, Type::Type_Enum::Psychic, { Stats::stats_value::DEFENCE, 2 });
	Attack_Move tackle("Tackle", 35, 95, Type::Type_Enum::Normal, 30);
	Status_Effect_Attack_Move poison_powder("Poison Powder", 15, 75, Type::Type_Enum::Poison, 0, { Status_Effect::status_effect_value::POISON, 100 });
	Stats_Value_Attack_Move growl("Growl", 40, 100, Type::Type_Enum::Normal, 0, { Stats::stats_value::ATTACK,1 });
	...
	bulbasaur.define_known_moves({ std::array<Move,4>{tackle,growl} });
