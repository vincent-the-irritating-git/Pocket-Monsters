...
Gen1_Pokemon alakazam(65,"Alakazam", Type::Type_Enum::Psychic, Pokemon::Evolutions(), Gen1_Pokemon::Gen1_Stats(55, 50, 45, 135, 120));
Gen1_Pokemon pinsir(127, "Pinsir", Type::Type_Enum::Bug, Pokemon::Evolutions(), Gen1_Pokemon::Gen1_Stats(65, 125, 100, 55, 85));
...
int main() {
	...
	Move_List.insert({ recover.m_name,recover });
}